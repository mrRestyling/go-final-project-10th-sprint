...
ls -la dir2/hello.sh // доп проверка
...
./dir2/hello.sh $NAME >> dir1/summary.txt //не было в теории,гугл
# перемещаем с переименованием task/dir1/summary.txt в task/Практическое задание
mv dir1/summary.txt practic //контейнер не воспринимает русский язык
# выводим на консоль содержимое файла task/Практическое задание
cat practic //не понимаю, почему выдаёт ошибку
# ищем в файле "Практическое задание" строки, которые содержат слово "dir"
# и затем отсортировываем их
grep -i -H "dir" practic | sort
